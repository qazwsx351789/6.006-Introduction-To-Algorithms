...
triangle. Therefore, the rendering time for a node is $\Theta(1)$. }
...
From Problem (b) we know that there are $3 \cdot 4^i$ nodes at level $i$. Therefore, the 
